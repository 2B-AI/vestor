...
import { Wallet, LogOut, Menu, X, Zap, Trophy, PlusCircle, History } from "lucide-react";
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-neon">
        ...
        <div className="flex items-center gap-3">
          {connected ? (
            ...
            <Button
              onClick={connect}
              className="hidden sm:flex bg-gradient-to-r from-primary to-solana hover:opacity-90 text-white font-bold gap-2 rounded-full px-6"
            >
              <Wallet className="h-4 w-4" />
              Connect Wallet
            </Button>
              ...
              <div className="pt-2 border-t border-border/50 mt-2">
                {connected ? (
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-primary to-solana text-white font-bold gap-2 rounded-full"
                  >
                    <Wallet className="h-4 w-4" />
                    Connect Wallet
                  </Button>
