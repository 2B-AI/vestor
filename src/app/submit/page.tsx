      ...
      {submitted ? (
        ...
        >
          ...
          <p className="text-muted-foreground mx-auto max-w-md">
            ...
            {form.ticker}) has been submitted for review. You&apos;ll be
            notified when it is approved by the system.
          </p>
          <div className="bg-grid inline-block rounded-xl p-4">
            ...
            <p className="text-primary text-lg font-bold">~3-6 hours</p>
          </div>
          <div className="pt-4">
            <Button
              onClick={() => {
          ...
          <div className="bg-primary/5 border-primary/10 flex items-start gap-3 rounded-xl border p-4">
            ...
            <div className="text-muted-foreground space-y-1 text-sm">
              <p>
                ...
                project will enter the queue and be picked for the next
                available voting slot once it is approved.
              </p>
              <br />
              <p>
                If your project doesn&apos;t win, it can be resubmitted in a
                future round.
              </p>
            </div>
          </div>
