        ...
        <div className="mx-auto max-w-7xl px-4 pt-20 pb-16 sm:px-6">
          ...
          >
            ...
            <p className="text-muted-foreground mx-auto max-w-3xl text-xl leading-relaxed">
              Vestor operates like American Idol for AI projects — the community
              submits, votes on, and funds AI project launches on Solana. Each
              1-hour voting round determines which project gets funded, with
              automatic token creation and Meteora liquidity pool seeding.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div className="text-muted-foreground space-y-4 text-lg leading-relaxed">
              <p>
                Traditional AI project launches are plagued by failed ventures,
                and lack of community input. Most tokens launch without any
                validation or community backing.
              </p>
              <p>
